...
import Clima from './components/Clima'; // Nuevo componente
      ...
      <div className="d-flex" style={{ minHeight: '100vh' }}>
        ...
        <nav className="flex-column p-3 bg-dark text-light" style={{ 
          ...
          <div className="d-flex flex-column gap-2">
            ...
            <Link to="/clima" className="nav-link p-2 text-light text-decoration-none rounded hover-effect">🌤️ Clima</Link> {/* Nueva opción */}
        ...
        <div className="p-4 flex-grow-1" style={{ backgroundColor: '#f8f9fa', minHeight: '100vh' }}>
          <Routes>
              ...
              <div className="text-center mt-5">
                ...
                <div className="row mt-5">
                  ...
                  <div className="col-md-3 mb-3">
                    <div className="card">
                      <div className="card-body">
                        <h5 className="card-title">🌤️ Clima</h5>
                        <p className="card-text">Información meteorológica</p>
                      </div>
                    </div>
                  </div>
                  <div className="col-md-3 mb-3">
            ...
            <Route path="/clima" element={<Clima />} /> {/* Nueva ruta */}
